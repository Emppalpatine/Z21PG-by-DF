...
#define DETECT_SHORT_INT_VALUE 350 //(OPTIONAL) value = (Amper * senseResist) / (Uref / 1024)
...
#define senseResist 0.115   //or 0.1   // actual resistor for measuring current on track
